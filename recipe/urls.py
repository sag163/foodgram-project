...
urlpatterns = [
    ...
    path("favorites/<int:recipe_id>/", views.favorites_delete, name="favorites_delete"),
    path("purchases", views.purchases, name="purchases"),
    path("shop_list/", views.shop_list, name="shop_list"),
    path("purchases/<int:recipe_id>/", views.purchases_delete, name="purchases_delete"),
    path("new_recipe/", views.new_recipe, name="new_recipe"),
    path("shop_list/dowload/", views.dowload_shop_list, name="dowload_shop_list"),
    path("shop_list/<int:recipe_id>/", views.delete_recipe, name="delete_recipe"),
    path("shop_list/", views.shop_list, name="shop_list"),
    path("subscriptions", views.subscriptions, name="subscriptions"),
